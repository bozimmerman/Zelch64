!--------------------------------------------------
!- Saturday, May 20, 2017 1:53:48 AM
!- Import of : 
!- c:\src\zelch64\config.prg
!- Commodore 64
!--------------------------------------------------
5 POKE55,0:POKE56,117:POKE51,0:POKE56,117
10 POKE53280,0:POKE53281,0:PRINTCHR$(14)+"{pink}{clear}{down*2}{right*7}Zelch v1.7 Configurator"
...
60 IFA$="n"THENPRINT"{light blue}Working...":OPEN1,8,15,"n0:Zelch v1.7x,{pound}{pound}":CLOSE1:GOTO90
70 IFA$<>"y"THEN50
80 PRINT"{light blue}Moment...":OPEN1,8,15,"n0:Zelch v1.7x":CLOSE1
...
240 OPEN8,8,8,"{pound}Mpreps,s,w":PRINT#8,N$:PRINT#8,N:PRINT#8,"foicuseqmtv"
250 PRINT#8,"00000007554":PRINT#8,"hsedlcvia"
251 PRINT#8,"lcrsnqpxd":PRINT#8,"000000377"
...
640 PRINT"{yellow}{clear}Zelch Copy-Some":PRINT"{white}01):{yellow}{pound}v1.7 ml1      :2"
650 FI$="{pound}v1.7 ml1":GOSUB1000:
