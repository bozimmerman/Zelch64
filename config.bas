...
60 IFA$="n"THENPRINT"{light blue}Working...":OPEN1,8,15,"n0:Zelch v2.3x,{pound}{pound}":CLOSE1:GOTO90
70 IFA$<>"y"THEN50
80 PRINT"{light blue}Moment...":OPEN1,8,15,"n0:Zelch v2.3x":CLOSE1
...
285 PRINT#8,"B-Baud change"+Q$+"S-Status"+Q$+"C-Chat":PRINT#8,"@-Edit"
