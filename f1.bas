!--------------------------------------------------
!- Saturday, May 20, 2017 12:05:29 AM
!- Import of : 
...
1000 CS=0:TX$="{clear}{reverse on}{light blue}Entering Sig System{reverse off}":GOSUB400:GOSUB1010:GOTO2000
1010 TX$="{down*2}{white}{reverse on}Entering Sig{reverse off}"+STR$(CS+1):GOSUB400:CM=0:FORI=0TOGG:Z1(I)=0:Z2(I)=0
...
1135 K=0:KK=0:FORI=1TONM:K=K+Z1(I):IFZ2(I)>PPTHENKK=KK+1:
1140 NEXTI:TX$=CHR$(13)+STR$(NM)+" Bulletins and "+STR$(K)+" Responses":GOSUB400
1150 TX$=STR$(KK)+" {cyan}{reverse on}new Bulletins/Responses{reverse off}":GOSUB400
1199 VF=0:RETURN
...
1901 TX$=CHR$(13)+"Updating Index...":GOSUB400
...
2005 TX$=CHR$(14)+CHR$(13)+"{yellow}{reverse on}Sig{reverse off}"+STR$(CS+1)+":":GOSUB400
...
3030 NEXTI:GOTO2000
4000 TX$="{pink}{white}New Sig {reverse off}{white}#:":GOSUB400:GOSUB300:IFLEN(I$)>4THEN2000
...
5000 TX$="MSG # or RETURN:":GOSUB400:GOSUB300:IFLEN(I$)>4ORI$=""THEN2000
5010 I=VAL(I$):CM=I
5015 IFCM<1THENCM=1:GOTO5030
5020 IFCM>NMTHENOU$=CHR$(13):GOSUB200:CM=NM:WI=0:GOTO2000
5030 I1=Z1(CM):I2=Z2(CM)
5040 OPEN8,SD(CS),8,"{pound}msg"+STR$(CS)+STR$(CM)
5050 SYS49164
5060 CLOSE8:IFI1=0THEN5500
5070 TX$=CHR$(14)+"{pink}R)ead, {yellow}S)kip, {white}Q)uit,or {light green}RETURN:":GOSUB400
...
5220 TX$="{clear}{white}Response #"+STR$(I9+1):GOSUB400:SYS49164:CLOSE8
5230 TX$=CHR$(13)+CHR$(14)+"{cyan}RETURN cont. A)bort{white}:":GOSUB400
5240 GOSUB100:IFIN$="a"THEN5500
5250 IFIN$<>CHR$(13)THEN5240
5255 TX$=" ":GOSUB400
5260 I9=I9+1:GOTO5200
5500 TX$=CHR$(14)+CHR$(13)+"{light green}{reverse on}Public Reply?{reverse off}{white}:":GOSUB400
...
7050 IFI$=""THEN2000
7060 S$=I$:GOSUB10000:QD$="TIME>"+TT$+" SUBJECT>:"+S$+CHR$(13)+CHR$(13)
...
13000 I=1
13010 OPEN8,SD(CS),8,"{pound}msg"+STR$(CS)+STR$(I):SYS49179
13020 I$=RIGHT$(I$,LEN(I$)-2):I$=" P"+I$:CLOSE8
13030 GOSUB100:IFIN$=" "THEN2000
13040 TX$="Msg #"+STR$(I)+":"+STR$(Z1(I))+" Responses":GOSUB400
13050 SYS49161,I$:GOSUB100:IFIN$=" "THEN2000
13060 I=I+1:IFI>NMTHEN2000
13070 GOTO13010
