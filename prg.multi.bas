!--------------------------------------------------
!- Saturday, May 20, 2017 4:12:04 PM
!- Import of : 
...
8030 GOSUB100:IFIN$="q"THENTX$="q":GOSUB210:GOTO5165
...
8504 TX$="u":GOSUB210:TX$="{clear}{down*2}{f1}Go To MULTI-SEND!":GOSUB210
8505 F$=""
8510 GET#5,A$:IFPEEK(830)=1THEN1230
8520 IFA$<>"{ct i}"THEN8510
8525 PRINT"{clear}{down*2}Multi-Recieving:";:
8530 GET#5,A$:IFA$=""ORA$="{ct i}"THEN8530
8535 IFPEEK(830)=1THEN1230
8540 IFA$=CHR$(13)THENPRINT:GOTO8600
8550 IFA$=CHR$(4)ORPEEK(830)=1THENFORX=1TO2500:NEXTX:GOTO5165
