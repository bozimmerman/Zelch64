!--------------------------------------------------
!- Saturday, May 20, 2017 2:17:13 PM
!- Import of : 
!- c:\src\zelch64\pgm.#1.prg
!- Commodore 64
!--------------------------------------------------
...
8003 IFI$="q"THEN2120
8004 IFI$<>"r"THEN8001
8010 TX$="Reset vote box?{ct c}":GOSUB210:GOSUB190:IFI$<>"y"THEN2120
8020 OPEN1,8,15,"s0:{pound}vote box":CLOSE1:OPEN8,8,8,"0:{pound}vote box,s,w"
8100 PRINT#8,"start":CLOSE8:GOTO2120
8110 TX$="{white}Loading Vote!":GOSUB210:OPEN8,8,8,"0:{pound}vote,s,r":INPUT#8,I1$
8120 INPUT#8,I2:FORI=0TOI2:INPUT#8,I1$(I):INPUT#8,I2$(I):NEXTI:CLOSE8
...
8280 OPEN1,8,15,"s0:{pound}vote":CLOSE1:OPEN8,8,8,"0:{pound}vote,s,w":PRINT#8,I1$:PRINT#8,I2
8290 FORI=0TOI2:PRINT#8,I1$(I):PRINT#8,I2$(I):NEXTI:CLOSE8:GOTO2120
