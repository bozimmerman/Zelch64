!--------------------------------------------------
!- Saturday, May 20, 2017 4:37:06 PM
!- Import of : 
...
8030 C2=INT(I7/256):C3=C2*256:C1=I7-C3:OPEN1,8,15,"i0":OPEN2,8,3,"0:{pound}log1"
8040 I=0:GOSUB6:GET#2,A$:INPUT#1,E1
8050 IFA$<>"{pound}"ORE1>0THENSYSZ,2:SYSZ,1:TX$="Not found!":GOSUB210:GOTO3740
8055 SYS38233:SYSZ,2:SYSZ,1:IFI$="EMPTY"ORNA=I7THENE1=5:GOTO8050
8056 IFMF=1THEN8065
