...
140 PRINT:PRINT"ACS:";AC$:INPUT"NEW{sh space}ACS";AC$:AC=VAL(AC$):RETURN
...
430 POKE720,0:PRINT"{blue}Logged off at:";L2$:PRINT"{purple}Calls today:";STR$(PEEK(733))
...
622 PRINT"{light blue}{down}{reverse on}Choose{reverse off}:{reverse on} {reverse off}{left}{blue}";
...
840 SYSZ,2:SYSZ,1:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}userlog"
...
900 C2=INT(NA/256):I3=C2*256:C1=NA-I3:I=90:GOSUB6:GET#2,A$:INPUT#1,E1
...
1310 C1=NA-C3:TX$="{red}{reverse on}Bye...":GOSUB210:GOSUB80:GOSUB1350
1311 PRINT"{white}{reverse on}Resetting!":GOSUB5:OPEN1,8,15:OPEN8,8,8,"0:{pound}Log!,a"
1312 INPUT#1,E:IFE<20THEN1318
1313 SYSZ,8:OPEN8,8,8,"0:{pound}Log!,s,w":PRINT#8,"start"
1318 PRINT#8,STR$(MN)+"/"+STR$(DA):FORI=0TOP0-1:PRINT#8,P0$(I):NEXTI
1319 SYS38215:PRINT#8,"off at:"+I$:PRINT#8,CHR$(1):SYSZ,8:SYSZ,1
1320 OPEN1,8,15,"s0:{pound}last caller":SYSZ,1:SYS38215
...
1345 GOSUB6810:IFM0=0THENPRINT#5,"+++":GOSUB85:GOSUB85:GOSUB80:CLOSE5:RUN
1350 SYSZ,1:SYSZ,2:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}userlog"
1370 I=5:GOSUB6:PRINT#2,NA$:I=25:GOSUB6:PRINT#2,PH$:I=35:GOSUB6
1380 PRINT#2,AC$:I=40:GOSUB6:PRINT#2,RN$:I=60:GOSUB6
1390 PRINT#2,LC$:I=80:GOSUB6:PRINT#2,TM$:I=90:GOSUB6:PRINT#2,PS$:CT=0
...
1420 OPEN1,8,15:OPEN2,8,3,"0:{pound}calls":I=1
1430 GOSUB6:PRINT#2,CA$:SYSZ,1:SYSZ,2:RETURN
1440 EQ=0:SYSZ,2:SYSZ,1:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}userlog"
...
1510 OPEN1,8,15:OPEN2,8,3,"0:{pound}calls":I=1
