!--------------------------------------------------
!- Saturday, May 20, 2017 2:39:16 AM
!- Import of : 
!- c:\src\zelch64\@1.prg
!- Commodore 64
!--------------------------------------------------
...
860 TX$=CHR$(13)+"{yellow}Enter your ID number or NEW:{ct c}":GOSUB210:GOSUB190
...
930 SYS49185:PS$=A$+I$
940 TX$=CHR$(13)+"{pink}Enter your password        :{ct c}":GOSUB210:GOSUB190
...
1240 POKE1,55:IFPEEK(830)=1THENTX$="{red}Time UP!!"
1250 POKE703,MN:POKE704,DA:OPEN1,8,15:CLOSE1
1260 IFNA$=""THENPOKE702,16:GOSUB210:RUN
...
2120 SYS49167:TX$=CHR$(13)+"{green}TIME={light green}"+I$+"{white}:(?):{blue}C{light blue}O{cyan}M{white}M{yellow}A{pink}N{red}D{white}:{ct c}":GOSUB210
2121 IFPEEK(681)=1THENTX$="{cm w}{up}{cm e}{down}{cm q}{down}{left*2}{cm r}{left}{up}{ct c}":GOSUB210
...
2170 ONGGOTO2200,2250,2190,2270,2340,2440,3740,3150,4050,5170,5740,6200,6250
2180 GOTO2120
...
2340 TX$="Start at:{ct c}":GOSUB210:GOSUB190:IFLEN(I$)>4ORI$=""THEN2320
...
2880 POKE763,1
2890 POKE705,0
2891 S0=0:FORI=0TO50:TT$="":NEXTI:A=FRE(0):OU$=CHR$(14):GOSUB120:RETURN
...
3040 TX$="at (0-"+STR$(LN-1)+"){ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN2550
...
3460 TX$="User #{ct c}":GOSUB210:GOSUB190:IFLEN(I$)>4ORVAL(I$)<1THEN3150
...
3646 IFI$<>""THENTT$(6)=I$
3650 TX$="S)ave E)dit or A)bort:{ct c}":GOSUB210:GOSUB190:IFI$="e"THEN3510
...
3810 TX$=Q$+"User ID#{ct c}":GOSUB210:GOSUB190:IFLEN(I$)>4ORVAL(I$)<1THEN3740
3820 I7=VAL(I$)
...
4310 IFG>0THENONGGOTO4330,4360,4400,4720,4790,2120,4840,4940,5120
4320 GOTO4260
4330 TX$="Sigs: ":GOSUB210:FORI=0TOSG:IFSG(I)>ACTHEN4350
4340 TX$=STR$(I+1)+"):"+SG$(I):GOSUB210
4350 NEXTI:GOTO4260
4360 TX$="{white}New Sig:{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN4260
4370 I=VAL(I$):Q=I-1:IFQ=CSORI<1OR(Q>SG)THEN4260
4380 IFAC>=SG(Q)THENCS=Q:GOSUB4060
4390 GOTO4260
4400 TX$="MSG # or RETURN:{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN4260
4410 I=VAL(I$):CM=I
...
4690 TX$="Num to Skip:{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN4450
...
4940 V1=SD(CS):TX$="Msg #{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN4260
4950 M=VAL(I$):T=Z1(M):IFM>NMORT=0ORM<1THEN4260
...
5111 GOTO4260
5120 V1=SD(CS):TX$="Delete Msg #{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN4260
5130 I=VAL(I$):IFI>NMORI<1THEN4260
...
5270 POKE512,0:TX$="{white}UPLOAD!":GOSUB210:TX$="Filename:{ct c}":GOSUB210:GOSUB190
...
5460 POKE512,0:TX$="{white}DOWNLOAD!":GOSUB210:TX$="Filename:{ct c}":GOSUB210:GOSUB190
...
5601 E$="dl:"+FI$:GOSUB12
5610 SYS49173:POKE51224,255:SYS49158
5620 CLOSE1:CLOSE2:PRINT#5,"loading system ml":I$="{pound}v2.0 ml1":SYS51971,I$
5630 GOTO5170
5640 TX$="{pink}P)RG{white} or {yellow}S)EQ{white}:{ct c}":GOSUB210
...
5945 TX$=STR$(I1(I))+"-"+I2$(I)+" ("+STR$((I1(I)/O)*100)+"% )":GOSUB210
...
6210 GOSUB190:IFI$=""ORLEN(I$)>4THEN2120
6220 I=VAL(I$):IFI<200ORI>500THEN2120
...
6260 FI$="{pound}txt"+STR$(A):NN=1:GOSUB1200:IFPEEK(252)=0THEN6250
6270 TX$="hit return{ct c}":GOSUB210:GOSUB6370:GOTO6250
6300 TX$="UD Sections:"
6301 FORI=0TOUD:IFAC>=UA(I)THENTX$="{white}"+STR$(I+1)+"):"+UD$(I):GOSUB210
6310 NEXTI:GOTO5170
6330 TX$="{cyan}New UD{white}:{ct c}":GOSUB210:GOSUB190:IFI$=""ORLEN(I$)>4THEN5170
6340 I=VAL(I$):IFI<1ORI>UD+1THEN5170
