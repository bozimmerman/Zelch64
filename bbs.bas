!--------------------------------------------------
!- Saturday, May 20, 2017 4:36:34 PM
!- Import of : 
!- c:\src\zelch64\bbs.prg
!- Commodore 64
!--------------------------------------------------
1 PRINTCHR$(14):POKE762,39:POKE650,128:GOTO25
2 M0=PEEK(701):IFM0=0THENPRINT#5,"at"+A$:GOSUB89:GET#5,A$:GET#5,A$
3 POKE56579,32:POKE56577,0:GET#5,A$:GET#5,A$:RETURN
5 RETURN
6 POKE251,C1:POKE252,C2:POKE253,I:SYS38248:GOTO8
7 GOSUB6:SYS38233:RETURN
8 FORC3=1TO1:NEXT:SYS38248:RETURN
...
83 GOSUB89:PRINT#5,"+++";:GOSUB89:RETURN
85 T$=TI$
86 IFT$=TI$THEN86
87 RETURN
...
101 VY=PEEK(197):IFVY>6ORVY<3THENRETURN
102 VZ=PEEK(653):IFVY=5ANDVZ=1THEN108
103 IFVY=6ANDVZ=1THEN109
104 IFVY=6THEN150
106 IFVY<>5THENRETURN
107 PRINT:PRINT"TEMP ACS:"+STR$(AC):INPUT"TEMP ACS";AC:RETURN
108 I=255:GOSUB1700:PRINT"BURST!":RETURN
109 TX$=CHR$(13)+"Hold on...":GOSUB210:PRINT"F1 aborts..":POKE720,1:RETURN
...
150 PRINT:PRINT"SUBOP ACS:";P$(5):INPUT"SUBOP ACS";P$(5):RETURN
...
240 PRINT"Data disk(s) IN!":PRINT"Press {reverse on}RETURN{reverse off}";
260 GETA$:IFA$<>CHR$(13)THEN260
270 PRINT:POKE56334,PEEK(56334)AND254:POKE1,PEEK(1)AND251:POKE788,0:POKE789,203
280 POKE1,PEEK(1)OR4:POKE56334,PEEK(56334)OR1
290 OPEN1,8,15:OPEN8,8,8,"0:{pound}variables,s,r":INPUT#8,BN$:INPUT#1,E1
...
340 INPUT#8,M0:POKE701,M0:SYSZ,8:SYSZ,1
345 OPEN8,8,8,"{pound}last caller,s,r":SYS38230:L1$=I$:SYS32830:L2$=I$:INPUT#8,LZ
...
410 PRINT"{cyan}{reverse on}F3{reverse off} to log-on":POKE896,0:POKE720,0:PRINT"{light blue}Last Caller=";L1$
430 POKE720,0:PRINT"{blue}Logged off on:";L2$:PRINT"{purple}Calls today:";STR$(PEEK(733))
460 SYS38215:PRINT"{home}{down}{right*2}{white}DATE=";MN;"/";DA;"  TIME=";I$+"{black}"
...
540 GET#5,R$:IFR$="5"ORR$=CHR$(181)THENPOKE830,0:POKE714,0:GOSUB6800:GOTO690
...
564 GOSUB80:GOTO460
580 PRINT"{clear}{pink}Z{yellow}e{white}l{cyan}c{light blue}h {light green}SysOp {green}Menu:":PRINT"{red}1)BBS mode":PRINT"{pink}2)Monster Mode"
590 PRINT"{yellow}3)Zap Term":PRINT"{white}4)Read Feedback":PRINT"{cyan}5)Read Log"
622 PRINT"{light blue}6)Take Down BBS":PRINT"{light blue}{down}{reverse on}Choose{reverse off}:{reverse on} {reverse off}{left}{blue}";
630 GETA$:IFA$=""THEN630
640 IFA$="1"THENPRINT"1":GOTO390
650 IFA$="2"THENPRINT"2":DD=1:GOTO1530
660 IFA$="3"THENPRINT"3":I$="{pound}prg.term":GOTO88
665 IFA$="4"THENPRINT"4":FI$="{pound}feedback":GOSUB5690
667 IFA$="5"THENPRINT"5":FI$="{pound}Log!":GOSUB5690
668 IFA$="6"THEN671
669 GOTO630
671 PRINT"{down*2}ARE{sh space}YOU{sh space}SURE(Y/N)?"
672 GETA$:IFA$="n"THEN580
673 IFA$<>"y"THEN672
674 PRINT"{down*3}CLOSING{sh space}SYSTEM..."
675 OPEN1,8,15,"s0:{pound}last caller":SYSZ,1:OPEN8,8,8,"{pound}last caller,s,w"
676 PRINT#8,L1$:PRINT#8,L2$:PRINT#8,LZ:PRINT#8,HN:SYSZ,8:SYSZ,1:PRINT"{clear}":END
690 SYSZ,1:SYSZ,2:CLOSE7:SYSZ,8:FORI=0TO50:GET#5,A$:NEXTI
700 POKE681,0:TX$=CHR$(13)+CHR$(13)+"{white*2}connection!!!":GOSUB210:POKE1023,0
701 SYS38215:E$=I$+" Call":GOSUB12
710 TX$=CHR$(13)+CHR$(13)+"hit return:{ct c}":GOSUB210:TI$="000000"
730 GOSUB100:IFVAL(TI$)>59THEN1230
740 IFIN$<>CHR$(13)ANDIN$<>CHR$(10)THEN730
745 IFPEEK(714)=1THEN820
750 NA$="":TX$=CHR$(13)+CHR$(13)+"graphics":GOSUB210
755 TX$="is the above word in uppercase?{ct c}":GOSUB210:TI$="000000"
...
820 POKE681,1:TX$=IN$:GOSUB210:GOTO835
830 TX$="{f1}Need Linefeeds?{ct c}":GOSUB210:
831 GOSUB100:IFIN$="n"THENTX$="n":GOSUB210:GOTO835
832 IFIN$<>"y"THEN831
833 TX$="y":GOSUB210:POKE1023,1
835 NN=1:FI$="{pound}opening msg":IFPEEK(681)=1THENFI$=FI$+"/g"
839 GOSUB1200:I=5:GOSUB1710:CT=0
840 SYSZ,2:SYSZ,1:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}log1"
...
900 C2=INT(NA/256):I3=C2*256:C1=NA-I3:I=0:GOSUB6:GET#2,A$:INPUT#1,E1
920 IFA$<>"{pound}"ORE1>0THEN970
930 FORI=1TO5:SYS38233:NEXT:PS$=I$
...
1230 SYSZ,1:SYSZ,2:SYSZ,8:SYSZ,9:SYSZ,7:POKE682,0
...
1300 C2=INT(NA/256):C3=C2*256:LC$=" 0"
1310 C1=NA-C3:TX$="{red}{reverse on}Bye...":GOSUB210:GOSUB80:GOSUB1400:
1311 LC$=STR$(MN)+"/"+STR$(DA)
1312 PRINT"{white}{reverse on}Resetting!":GOSUB5:OPEN1,8,15:OPEN8,8,8,"0:{pound}Log!,a"
1313 INPUT#1,E:IFE<20THEN1318
1314 SYSZ,8:OPEN8,8,8,"0:{pound}Log!,s,w":PRINT#8,"start"
1318 PRINT#8,LC$:FORI=0TOP0-1:PRINT#8,P0$(I):NEXTI
1319 SYS38215:PRINT#8,"off at:"+I$:PRINT#8,CHR$(1):SYSZ,8:SYSZ,1
1320 OPEN8,8,8,"@0:{pound}last caller,s,w":SYS38215:PRINT#8,NA$+"  ":LC$=LC$+" "+I$
1330 PRINT#8,LC$:PRINT#8,LZ+1:PRINT#8,HN:POKE702,16:SYSZ,8:SYSZ,1
1340 GOSUB6810:IFM0=0THENPRINT#5,"+++":GOSUB85:GOSUB85:GOSUB80:CLOSE5:RUN
1350 SYSZ,1:SYSZ,2:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}log1"
1370 Q$=CHR$(13):A$="{pound}"+NA$+Q$+PH$+Q$+AC$+Q$+RN$+Q$+PS$
1380 I=0:GOSUB6:PRINT#2,A$:SYSZ,1:SYSZ,2:IFY0=0THENRETURN
1400 IFY0=1THENY0=0:GOTO1410
1405 I2=INT(HN/256):P$(1)=STR$(I2):I2=I2*256:I1=HN-I2:P$(0)=STR$(I1)
1410 Q$=CHR$(13):A$=CA$+Q$+LC$+Q$:FORI=0TO9:A$=A$+P$(I)+Q$:NEXT:
1420 OPEN1,8,15:OPEN2,8,3,"0:{pound}log2":I=0
1430 GOSUB6:PRINT#2,A$:SYSZ,1:SYSZ,2:RETURN
1440 EQ=0:SYSZ,2:SYSZ,1:SYSZ,8:OPEN1,8,15:OPEN2,8,3,"0:{pound}log1"
1470 I=0:GOSUB6:GET#2,A$:INPUT#2,NA$,PH$,AC$,RN$,PS$:SYSZ,2:SYSZ,1
1510 OPEN1,8,15:OPEN2,8,3,"0:{pound}log2":I=0:GOSUB6:INPUT#2,CA$,LC$
1520 FORI=0TO9:INPUT#2,P$(I):NEXT:SYSZ,2:SYSZ,1:RETURN
...
2170 ONGGOTO2200,2250,2190,2270,2340,2440,3735,3150,4050,5160
2175 G=G-10:ONGGOTO5740,6200,6250,6500,7200,7300
2180 GOTO2120
...
2280 TX$="{f1}Paging SysOp...":GOSUB210:POKE53280,1:FORX=1TO40
2300 FORI=1TO50:NEXT:TX$="{f1}>{ct g}{ct c}":GOSUB210:NEXTX:GOTO2120
...
2341 IFI$="?"THEN2381
2342 IFI>0ORI$=""THEN2390
2345 OPEN8,8,8,"0:{pound}members,s,r":S$=I$:Q=0:SYS38230:SYS38209,I$
...
2380 GOTO2350
2381 Q$=CHR$(13):TX$="{f1}ENTER{sh space}ID #'S"+Q$+"{f1}SEARCH LETTERS"+Q$+"{f1}OR{sh space}(RETURN)"+Q$
2382 GOSUB210:GOTO 2340
2390 OPEN8,8,8,"0:{pound}members,s,r":SYS38230:SYS38209,I$
2400 SYS38230:IFI$=""THEN2430
2410 X=VAL(RIGHT$(I$,LEN(I$)-1)):IFX<ITHEN2400
2414 SYS38209,I$
2415 SYS38230:IFI$=""THEN2430
2416 SYS38209,I$:GOSUB100:IFIN$=" "THEN2430
2420 GOTO2415
2430 SYSZ,8:GOTO2320
...
2525 A=FRE(0):IFS1=1THENS1=0:GOTO2535
2526 OU$="{clear}":GOSUB120
2530 TX$="{reverse on}{f1}message maker!{reverse off}":GOSUB210
2535 POKE705,1:LO=1:POKE762,36:POKE764,0:POKE763,0
2540 TX$="{f1}type /h for help"+CHR$(13)+"{f1}50 lines max. go:{white} ":GOSUB210
2550 IFLO=1THENI5=LN:GOSUB3460
2555 GOSUB190:IFI$=""THENI$=CHR$(144)
...
2600 ONGGOTO2630,2640,3070,2970,2960,2900,2950,3040,2840,6660,6670,6700,3490
...
2675 IFS0=1THENS0=0:OPEN1,V1,15,"s0:"+FF$:SYSZ,1:GOTO2685
2680 TX$="saving...":GOSUB210
2685 OPEN1,V1,15:OPEN8,V1,8,"0:"+FF$+",a":INPUT#1,E
2690 IFE<20THENPRINT#8,CHR$(1):GOTO2720
2700 SYSZ,1:SYSZ,8:OPEN8,V1,8,"0:"+FF$+",s,w"
2720 IFQQ$<>""ANDQD$<>""THENPRINT#8,QQ$:PRINT#8,QD$:PRINT#8,CHR$(2)
2730 TT$(LN)=CHR$(144):IFUP=1THENPRINT#8,CHR$(142)+CHR$(147)
2735 FORI=0TOLN-1
2740 PRINT#8,TT$(I)
2750 NEXTI:SYSZ,8:SYSZ,1:TX$="saved":GOSUB210
2759 GOTO2890
...
2880 POKE763,1
2890 POKE705,0:QQ$="":QD$="":UP=0:POKE762,39:LO=0
...
2962 TX$=STR$(Q)+">"+TT$(Q)+CHR$(0):TX$=RIGHT$(TX$,LEN(TX$)-1):GOSUB210
2963 GOSUB100:IFIN$=" "THEN2550
2964 Q=Q+1:IFQ<=LN-1THEN2962
2965 GOTO2550
2970 TX$="from (0-"+STR$(LN-1)+"){ct c}":GOSUB210:GOSUB111:I1=I:IFI1>LN-1THEN2550
2990 TX$="to ("+STR$(I1)+"-"+STR$(LN-1)+"){ct c}":GOSUB210:GOSUB111:
3010 I2=I:IFI2>LN-1ORI2<I1THEN2550
3020 I3=I2-I1+1:FORI=I1TOLN-I3+1:TT$(I)=TT$(I+I3):NEXTI:LN=LN-I3:IFLN<0THENLN=0
3030 A=FRE(0):GOTO2550
3040 GOSUB6450:IFER=1THEN2550
3050 I1=Q:IFLN+1>50THEN2550
3060 FORI=LNTOI1+1STEP-1:TT$(I)=TT$(I-1):NEXTI:TT$(I1)="{black}":LN=LN+1:GOTO2550
...
3130 TX$="rewrite line":GOSUB210:IFLO=1THENI5=Q:GOSUB3460
3135 GOSUB190:IFI$<>""THENTT$(Q)=I$
3140 GOTO2550
...
3190 IFIN$="e"THENI$="{pound}prg.user1":GOTO88
3191 IFIN$="x"THENI$="{pound}prg.user2":GOTO88
3192 IFIN$="r"THENTX$="{f1}LOADING...":GOSUB210:GOSUB1440:GOTO3150
...
3280 IFQ$="$"THENPOKE253,0:OPEN8,DV,0,I$:SYS38224:SYSZ,8:SYSZ,1:GOTO3230
3285 IFQ$="%"THEN6480
3290 IFLEN(I$)<4ANDVAL(I$)>7ANDVAL(I$)<11THENDV=VAL(I$):GOTO3230
3300 OPEN1,DV,15,I$:INPUT#1,E,E1$,E2,E3:SYSZ,1
...
3460 TX$=STR$(I5):IFI5<10THEN3480
3470 TX$=RIGHT$(TX$,LEN(TX$)-1)
3480 TX$=TX$+">{ct c}":GOSUB210:RETURN
3490 IFLO=0THENLO=1:TX$="l/n on":GOSUB210:POKE762,36:GOTO2550
3495 TX$="l/n off":GOSUB210:POKE762,39:LO=0:GOTO2550
...
4070 CM=0:I1=0:I2=0:J0=0:FI$="{pound}sigmsg"+STR$(CS+1):GOSUB1200:OPEN1,8,15
4072 OPEN2,8,3,"0:{pound}Sig"+STR$(CS+1)
4075 FORI=1TONM:Z1(I)=0:Z2(I)=0:NEXTI:C2=0
4090 C1=1:I=1:GOSUB7:NM=VAL(I$):I=7:GOSUB7:MP=VAL(I$):FORC1=2TONM+1:J=C1-1
4100 I=1:GOSUB7:Z1(J)=VAL(I$):I=7:GOSUB7:Z2(J)=VAL(I$)
4110 I1=I1+Z1(J):IFZ2(J)>PPTHENJ0=J0+1:
4120 NEXTC1:SYSZ,2:SYSZ,1:Q$=CHR$(13)
...
4150 OPEN1,8,15:OPEN2,8,3,"0:{pound}Sig"+STR$(CS+1)
4170 I=1:C1=1:C2=0:GOSUB6:PRINT#2,NM:I=7:GOSUB6:PRINT#2,MP
4175 SYSZ,2:SYSZ,1:RETURN
4180 OPEN1,8,15:OPEN2,8,3,"0:{pound}Sig"+STR$(CS+1):C1=I+1:I=1:C2=0:GOSUB6
4190 PRINT#2,A:I=7:GOSUB6:PRINT#2,B:SYSZ,2:SYSZ,1:RETURN
...
4890 SYS38215:QQ$=QQ$+"  {f1}TIME:"+I$:QD$="{f1}SUBJECT:"+S$+Q$:IFSF(CS)>NMTHENNM=NM+1
...
5160 TX$="{clear}{down}{f1}Upload/Download system!":GOSUB210:I$="{pound}prg.udsec":GOTO88
5165 FI$="{pound}udmenu":GOSUB1200:GOTO5170
5166 GOTO5170
5169 FORI=0TO3500:NEXT
5170 TX$="{down*2}{f1}U{f1}/{f1}D{white}"+STR$(CU+1)+":{ct c}":GOSUB210
5180 GOSUB100:IFIN$=""THEN5180
5185 IFIN$=CHR$(13)THENTX$=" ":GOSUB210:GOTO5170
...
5220 TX$=IN$:GOSUB210:ONGGOTO8100,2120,5270,5460,8200,8300,8400,5260
5260 I$="{pound}prg.multi":GOTO88
...
5420 SYS49173:SYS49161:IFPEEK(512)=1THEN5634
5421 E$="ul:"+FI$:GOSUB12:P$(3)=STR$(VAL(P$(3))+1)
5430 OPEN1,UV(CU),15:OPEN2,UV(CU),2,"0:"+FI$:INPUT#1,E:IFE>0THEN5620
5440 FORI=1TO1300:NEXTI:SYS61310:SYS49173:SYS49155
5450 FORX=1TO150:NEXTX:POKE668,PEEK(667):SYS49173:YU=1:GOTO5620
5451 TI$="000000"
...
5490 FI$=I$:GOSUB5640:IFLEFT$(FI$,1)<>"{pound}"THENFI$=CHR$(64+CU)+FI$
5495 IFLEFT$(FI$,1)="{pound}"ANDAC<9THEN5170
5500 FI$=FI$+"r":OPEN1,UV(CU),15:OPEN2,UV(CU),2,"0:"+FI$:INPUT#1,E
...
5630 IFYU=0THEN5634
5631 OPEN8,UV(CU),0,"$0:z=u":SYS38245:SYSZ,8:IFPEEK(707)>50ORPEEK(708)>0THEN5634
5632 OPEN1,UV(CU),15,"s0:"+FI$:PRINT#1,"v":SYSZ,1:YU=0
5634 IFFH=1THENFH=0:GOTO9000
5635 IFYU=0THENOPEN1,UV(CU),15,"s0:^"+FI$:CLOSE1
5636 GOTO5170
...
5680 GOTO5640
5690 PRINT"{clear}":POKE720,1:OPEN8,8,8,"0:"+FI$+",s,r"
...
7300 TX$="{f1}Switch to ":IFPEEK(681)=1THENTX$=TX$+"ASCII and hit RETURN{ct c}":GOTO7310
7305 TX$=TX$+"COLOR/GRAPHICS and hit RETURN{ct c}"
7310 GOSUB210:POKE681,ABS(PEEK(681)-1)
7315 GOSUB6370:GOTO2120
