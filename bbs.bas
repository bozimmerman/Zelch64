!--------------------------------------------------
!- Saturday, May 20, 2017 3:11:20 AM
!- Import of : 
...
27 CLOSE5:OPEN5,2,3,CHR$(6)+CHR$(0)
30 DIMTT$(51),TT(51),Z1(50),Z2(50),P0$(250):POKE53280,0:BA=300
...
389 INPUT#8,HN:CLOSE8:FH=1:I=300:GOSUB6230
...
640 IFA$="1"THEN390
650 IFA$="2"THEN1530
660 IFA$="3"THENPRINT"{clear}term active":GOSUB90:SYS49188:GOTO390
...
700 POKE681,0:TX$=CHR$(13)+"{white}connection!!!":GOSUB210
...
6200 TX$="Baud is:"+STR$(BA):GOSUB210:TX$="New Baud (RETURN):{ct c}":GOSUB210
6210 GOSUB111:IFI=0THEN2120
6220 IFI<200ORI>500THEN2120
6225 TX$="Change baud and hit RETURN{ct c}":GOSUB210
...
6620 KD=0:CS=CS+1:IFCS>SGTHENTX$="Done.":GOSUB210:CS=CS-1:GOTO4260
