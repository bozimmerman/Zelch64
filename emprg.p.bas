!--------------------------------------------------
!- Saturday, May 20, 2017 4:56:34 PM
!- Import of : 
!- c:\src\zelch64\emprg.p.prg
!- Commodore 64
!--------------------------------------------------
8000 FORI=0TO9:POKE43+I,PEEK(721+I):NEXT
8010 FI$="{pound}empfile.mm":NN=1:GOSUB25
8020 TX$=CR$+"{f1}EMPIRE COMMAND(?):{ct c}":GOSUB5:C$="?cqtygwzo":GOSUB66
8021 IFG<4THENONGGOTO8010,9000,10000
8025 ONGGOSUB8100,8200,8300,8400,8500,8600
8026 GOTO8020
...
8600 TX$="{f1}{clear}SCANNING ZACARIAN{sh space}WARLORDS...":GOSUB5:OPEN2,8,3,"{pound}emprec"
8610 A=U1:B=U2:I=0:U2=0:FORX=1TO20:U1=X:GOSUB4:Z2(I)=VAL(I$)
8620 IFVAL(I$)>0THENINPUT#2,TT$(X)
8630 NEXTX:CLOSE2:OPEN2,8,3,"{pound}log1":U2=0:I=0:FORX=1TO20:IFZ2(X)=0THEN8650
8640 U1=X:GOSUB4:TX$=STR$(X)+"{f1}NAME:"+I$+CR$+"{f1}LAND{sh space}VALUE:"+TT$(X)
...
9015 ONGGOTO9016,9020,9050,9010
...
9055 ONGGOTO9056,9060,9100,9050
...
9300 TX$="{f1}STANDBY, LOADING PART{sh space}II":GOSUB5:
9310 FORI=0TO9:POKE721+I,PEEK(43+I):NEXT:SYS51971:LOAD"{pound}emprg.i",ST(NP)
