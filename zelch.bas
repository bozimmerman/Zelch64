...
3920 NEXT:TX$="Saved":GOSUB2040:CLOSE8:CLOSE1:RETURN
3930 TX$="Filename":GOSUB2040:GOSUB1890:QD$=CHR$(13):GOSUB3330
3940 IFEW=1THENCLOSE8:OPEN1,8,15,"s0:"+FI$:RETURN
3950 CLOSE8:RETURN
...
13000 TT$(LN)=IQ$:LN=LN+1:IQ$="":IFLN>=95THEN3490
