!--------------------------------------------------
!- Friday, May 12, 2017 11:10:56 PM
!- Import of : 
!- c:\src\zelch64\bak\emprg.w.prg
!- Commodore 64
!--------------------------------------------------
...
8030 IFI$="?"THENVD=DV(1,NP):FI$="{pound}empfile.wm":NN=1:GOSUB25:GOTO8020
...
8187 Z2(21)=Z2(21)-100:GOSUB8950:GOTO9000
...
8197 Z2(21)=Z2(21)-A:GOSUB8950:GOTO9000
8900 OPEN2,DV(1,NP),2,"{pound}emprec":A=U1:B=U2:I=0:U1=I9:U2=0:GOSUB4:I0=VAL(I$)
8910 FORI=21TO32:INPUT#2,Z2(I):NEXTI:CLOSE2:U1=A:U2=B:RETURN
8950 OPEN2,DV(1,NP),2,"{pound}emprec":A=U1:B=U2:I=0:U1=I9:U2=0:A$=STR$(I0)+CR$
